export function CloudflareWorkerSvgIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 256 231" preserveAspectRatio="xMidYMid" {...props}>
      <defs>
        <linearGradient id="cloudflare_workers__a" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
          <stop offset="0%" stopColor="#EB6F07" />
          <stop offset="100%" stopColor="#FAB743" />
        </linearGradient>
        <linearGradient id="cloudflare_workers__b" x1="81%" x2="40.5%" y1="83.7%" y2="29.5%">
          <stop offset="0%" stopColor="#D96504" />
          <stop offset="100%" stopColor="#D96504" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="cloudflare_workers__c" x1="42%" x2="84%" y1="8.7%" y2="79.9%">
          <stop offset="0%" stopColor="#EB6F07" />
          <stop offset="100%" stopColor="#EB720A" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="cloudflare_workers__d" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
          <stop offset="0%" stopColor="#EE6F05" />
          <stop offset="100%" stopColor="#FAB743" />
        </linearGradient>
        <linearGradient id="cloudflare_workers__e" x1="-33.2%" x2="91.7%" y1="100%" y2="0%">
          <stop offset="0%" stopColor="#D96504" stopOpacity=".8" />
          <stop offset="49.8%" stopColor="#D96504" stopOpacity=".2" />
          <stop offset="100%" stopColor="#D96504" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="cloudflare_workers__f" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
          <stop offset="0%" stopColor="#FFA95F" />
          <stop offset="100%" stopColor="#FFEBC8" />
        </linearGradient>
        <linearGradient id="cloudflare_workers__g" x1="8.1%" x2="96.5%" y1="1.1%" y2="48.8%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".5" />
          <stop offset="100%" stopColor="#FFF" stopOpacity=".1" />
        </linearGradient>
        <linearGradient id="cloudflare_workers__h" x1="-13.7%" x2="100%" y1="104.2%" y2="46.2%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".5" />
          <stop offset="100%" stopColor="#FFF" stopOpacity=".1" />
        </linearGradient>
      </defs>
