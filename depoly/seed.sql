...
INSERT INTO sys_menu (id, name, type, description, remark, icon, path, path_file, status, isShow, isCache, permission, isLink, order_no, createdAt, updatedAt, parent_menu_id) VALUES (32, 'menu.demo.health.health', 2, 'menu: health', NULL, '', '/demo/health/health', '', 1, 0, 0, NULL, 0, 1, '2024-03-30 13:31:12', NULL, 9);
INSERT INTO sys_menu (id, name, type, description, remark, icon, path, path_file, status, isShow, isCache, permission, isLink, order_no, createdAt, updatedAt, parent_menu_id) VALUES (33, 'menu.demo.health.cervical', 2, 'menu: cervical-vertebra', NULL, '', '/demo/health/cervical-vertebra', '', 1, 1, 0, NULL, 0, 2, '2024-03-30 13:31:12', NULL, 9);
