import { Layout, Row, Col, Card, Typography, Button, Space, Tag, Avatar, List, Divider, Tooltip } from "antd";
import {
  GithubOutlined,
  BookOutlined,
  RocketOutlined,
...
// 技术栈数据
const techStack = [
  { name: "React Router", icon: "🚀", color: "#FF6B6B", description: "路由框架" },
  ...
  return (
    <Content style={{ padding: "24px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      >
        <Row justify="center" align="middle">
          <Col xs={24} md={16} style={{ textAlign: "center" }}>
            ...
            >
              Remix Antd Admin 是一个全栈解决方案，帮助你快速启动基于 Remix 的 AI 项目。
              集成了现代 Web 开发的最佳实践和工具链。
            </Paragraph>
      ...
      >
        ...
        <Paragraph style={{ color: "rgba(255, 255, 255, 0.9)", marginBottom: "32px" }}>
