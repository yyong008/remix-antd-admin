...
export function useDeptList(params: DeptListParams) {
  return useQuery({
    ...
    queryFn: async () => {
      const res = await (getApiClient() as any).api.admin.system.dept.$get({
        query: {
...
export function useCreateDept() {
  ...
  return useMutation({
    mutationFn: async (data: any) => {
      const res = await (getApiClient() as any).api.admin.system.dept.$post({
        json: data,
      });
      return res.json();
    },
...
export function useUpdateDept() {
  ...
  return useMutation({
    mutationFn: async (data: any) => {
      const res = await (getApiClient() as any).api.admin.system.dept.$put({
        json: data,
      });
      return res.json();
    },
...
export function useDeleteDept() {
  ...
  return useMutation({
    mutationFn: async (data: { ids: string[] }) => {
      const res = await (getApiClient() as any).api.admin.system.dept.$delete({
        json: data,
      });
      return res.json();
    },
