  ...
  return (
    <div className=" text-gray-900 w-[60vw] pt-[100px]">
      ...
      <main className="mx-auto p-6  rounded-lg  mt-8">
        ...
        <p className="mt-4 text-gray-700">We may collect the following types of information:</p>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6">5. Data Retention</h2>
        <p className="mt-4 text-gray-700">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6">7. Updates and Changes</h2>
        <p className="mt-4 text-gray-700">
