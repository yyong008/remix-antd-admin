    ...
    >
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <Row gutter={[48, 48]} style={{ marginBottom: "48px" }}>
          ...
          <Col xs={24} md={8}>
            <div style={sectionTitleStyle}>核心特性</div>
            <List
              ...
              renderItem={(item) => (
                <List.Item style={{ padding: "8px 0", border: "none" }}>
                  <List.Item.Meta
                    ...
                    title={<Text style={{ color: "rgba(255, 255, 255, 0.8)" }}>{item.label}</Text>}
                  />
                </List.Item>
              )}
            />
          ...
          <Col xs={24} md={8}>
            <div style={sectionTitleStyle}>订阅更新</div>
            <Paragraph
              style={{
                color: "rgba(255, 255, 255, 0.7)",
                marginBottom: "16px",
        ...
        <Row gutter={[32, 32]} style={{ marginBottom: "48px" }}>
          ...
          {/* 额外链接列 */}
          <Col xs={12} md={6}>
            <div style={sectionTitleStyle}>支持</div>
            <Space direction="vertical" size="small" style={{ width: "100%" }}>
              <Link
                to="/support"
                style={linkStyle}
        ...
        <Row justify="center" style={{ marginTop: "24px" }}>
          <Col>
            <Text style={footerNoteStyle}>Made with ❤️ by the Remix Antd Admin team</Text>
          </Col>
        </Row>
      </div>
    </Footer>
