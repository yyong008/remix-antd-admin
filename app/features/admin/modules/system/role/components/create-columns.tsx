        ...
        if (auth.isSuperAdmin(record)) {
          return (
            <Space>
              ...
              <span style={{ color: "red", fontWeight: "bold" }}>{record.name}</span>
            </Space>
          );
        }
        ...
        if (auth.isAdmin(record)) {
          return (
            <Space>
              ...
              <span style={{ color: "blue", fontWeight: "bold" }}>{record.name}</span>
            </Space>
          );
        }
        return (
        ...
        return (
          <Space>
            <UpdateRoleModal
              ...
              refetch={refetch}
            />
            <DeleteAction title="确定要删除次角色吗？" record={record} refetch={refetch} />
          </Space>
        );
      },
    },
