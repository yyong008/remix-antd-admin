...
// controllers
import { AdminChangeLogController } from "~/server/controllers/docs";

export const loader = AdminChangeLogController.loader;
export const action = AdminChangeLogController.action;
